...
export function ArticlePage() {
  ...
  const date = new Intl.DateTimeFormat(locale === "en" ? "en-US" : "es-PE", { dateStyle: "long", timeZone: "America/Lima" }).format(new Date(`${article.publishedAt}T12:00:00-05:00`));
  return (
    <Container maxW="5xl" py={{ base: "10", md: "18" }}>
      <Link to="/articulos"><HStack color="app.muted" mb="10" minH="11"><ArrowLeft size={17} /><Text>{copy.articles.back}</Text></HStack></Link>
