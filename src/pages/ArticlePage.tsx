...
export function ArticlePage() {
  ...
  return (
    <Container maxW="5xl" py={{ base: "10", md: "18" }}>
      ...
      {article.cover ? <AspectRatio ratio={16 / 8} mt={{ base: "10", md: "14" }} overflow="hidden" borderRadius={{ base: "2xl", md: "3xl" }}><ResponsiveImage image={article.cover} /></AspectRatio> : null}
