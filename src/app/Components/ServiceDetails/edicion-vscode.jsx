    ...
    const faqContent = [
        {
            ...
            content: 'Estoy aprendiendo a configurar: temas básicos, extensiones útiles que he descubierto, y algunos atajos de teclado que he encontrado prácticos. Comparto lo que he aprendido hasta ahora en mi proceso de aprendizaje.'              
        },
        {
            title: '¿Qué extensiones recomiendo?', 
            content: 'Por ahora conozco algunas básicas como Prettier para formateo, Live Server para desarrollo web, y estoy explorando GitLens para control de versiones. ¡Aún estoy descubriendo nuevas herramientas!'
        },
        {
            title: '¿Cómo manejo la sincronización?', 
            content: 'Estoy aprendiendo a usar Settings Sync para guardar configuraciones. Puedo ayudarte a configurar esta herramienta básica, pero aún estoy practicando con sus funciones avanzadas.'              
        },
        {
            title: '¿Creo snippets personalizados?', 
            content: 'Recién estoy empezando a crear snippets simples para estructuras básicas de código. Puedo compartir los que he creado hasta ahora y aprender juntos a mejorarlos.'              
        },
        {
            title: '¿Cómo mejoro la productividad?', 
            content: 'Estoy implementando los atajos de teclado que he aprendido y configuraciones básicas que he encontrado útiles en mi propio proceso de aprendizaje como desarrollador junior.'              
        },
        {
            title: '¿Ofrezco capacitación?', 
            content: 'Puedo compartir mis apuntes y lo que he aprendido hasta ahora, pero todavía estoy en proceso de dominar todas las funciones. ¡Podemos explorar juntos las configuraciones!'              
        }
    ]; 
