        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-12 text-center">
              <h2 className="big-title mb-0 mt--20 wow img-custom-anim-left">
                PLANES DE <span className="font2">PRECIOS</span>
              </h2>
            </div>
          </div>
        </div>
          ...
          <div className="row mt-50">
            <div className="col-lg-12 text-center">
              <p className="note-text">
                * Precios en Soles Peruanos (PEN). No incluye dominio ni
                hosting. Tiempos de entrega aproximados. Garantía de 7 días.
              </p>
            </div>
          </div>
        </div>
