...
const Pricing4 = () => {
  ...
  useEffect(() => {
    ...
    const mainThumb = document.querySelector(
      ".service-thumb-wrapper .hover-thumb img"
    );
  ...
  return (
    <div className="service-area style-two space-minimize bg-theme2">
      <div className="big-title-wrap text-center">
        <h2 className="big-title mb-0" data-count="[ 5 ]">
          Precios
        </h2>
      </div>
        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="service-thumb-wrapper">
              <figure className="hover-thumb">
                <Image
                  src="/assets/images/service/service-1_1.jpg"
                  alt="img"
                  width={375}
                  height={435}
            ...
            <div className="service-item-wrapper style-2">
              {serviceContent.map((item, i) => (
                <div key={i} className="service-item style-2">
                  ...
                  <div className="hover-thumb responsive-img">
                    <Image src={item.img} alt="img" width={375} height={435} />
                  </div>
                </div>
              ))}
            </div>
