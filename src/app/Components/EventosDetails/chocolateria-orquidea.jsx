        ...
        <div className="row">
          <div className="col-lg-12">
            <ul className="info-items xs-py-30">
              <li className="item"><span className="title">Empresa:</span><span className="text">{COMPANY_NAME}</span></li>
              <li className="item"><span className="title">Ubicación:</span><span className="text">{LOCATION}</span></li>
              <li className="item"><span className="title">Productos:</span><span className="text">{PRODUCTS}</span></li>
              <li className="item"><span className="title">Categorías:</span><span className="text">{CATEGORIES}</span></li>
              <li className="btn-wrap mt--20 sm-mt-0">
                <a className="circle-btn tp-hover-btn btn" href={WEBSITE_URL} target="_blank" rel="noopener noreferrer">
        ...
        <div className="row justify-content-between">
          ...
          <div className="col-lg-12">
            <div className="results-area">
              ...
              {/* Galería */}
              <div className="result-thumb mt-60 mb-60" style={{
                display: "flex",
                gap: "20px",
