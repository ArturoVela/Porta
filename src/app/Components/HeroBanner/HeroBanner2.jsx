...
const HeroBanner2 = () => {
  const heroContent = {
    ...
    content:
      "Soy ingeniero en sistemas y desarrollador web enfocado en crear soluciones prácticas, seguras y visualmente atractivas, combinando tecnología con diseño funcional.",
    title5: "ING. SISTEMAS",
    ...
    <section className="hero-wrapper hero-1" id="hero">
        ...
        <div className="hero-scroll smooth">
          <a href="#about-area-1" id="hero-scroll">
            ...
            <div className="hero-social_arrow">
              <Image
                src="/assets/images/icons/arrow-left-right.svg"
                alt="img"
                width={221}
                height={51}
              />
      ...
      <div className="hero-social-wrapper d-none d-xxl-block">
        ...
        <div className="hero-social_arrow mb-30">
          <Image
            src="/assets/images/icons/arrow-down-bottom.svg"
            alt="img"
            width={50}
            height={220}
          />
        ...
        <div className="hero-social">
          <div className="parallax-wrap">
            <div className="parallax-element">
              <a
                className="facebook"
                href="https://www.facebook.com/ArTuRoVeLaXD"
                target="_blank"
              >
          ...
          <div className="parallax-wrap">
            <div className="parallax-element">
              <a
                className="instagram"
                href="https://www.instagram.com/icchfinsa/"
                target="_blank"
              >
          ...
          <div className="parallax-wrap">
            <div className="parallax-element">
              <a
                className="Linkedin"
                href="https://www.linkedin.com/in/arturo-vela-aa81242ba/"
                target="_blank"
              >
            ...
            <div className="col-lg-12">
              ...
              >
                ...
                <div className="btn-wrap fade_right">
                  <Link
                    href="https://1drv.ms/b/s!AhTBs2k3EIAxjthfmoaQGB-VJxbvKA?e=jyDFsy"
                    target="_blank"
                    className="link-btn"
                  >
              ...
              <div className="row align-items-center justify-content-center">
                <div className="col-lg-4">
                  <div className="contact_mail">
                    <a className="color1" href="mailto:velaarturo70@gmail.com">
                      {heroContent.title3}
                    </a>
                  </div>
                </div>
                ...
                <div className="col-lg-4">
                  <p
                    className="hero-text wow img-custom-anim-right"
                    data-wow-delay="0.1s"
                    data-wow-duration="1.5s"
                  >
                    {heroContent.content}
              ...
              <h1
                className="hero-title font2 text-lg-end wow img-custom-anim-right"
                data-wow-delay="0.1s"
              ...
              <p
                className="place-title text-lg-end wow img-custom-anim-right"
                data-wow-delay="0.1s"
                data-wow-duration="1.7s"
              >
                {heroContent.title6}
