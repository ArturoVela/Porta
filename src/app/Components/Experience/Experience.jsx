...
const Experience = () => {
  const experiencetContent = [
    {
      name: "Caña Wasky - Perú",
      position: "Diseñador Ventas",
      year: "2025-1 - Presente",
    },
    {
      name: "K & F Products",
      position: "Administrador de ventas",
      year: "2024-7 - 2024-9",
    },
    {
      name: "Pachas Café - Perú",
      position: "Diseñador Web",
      year: "2024-3 - 2024-5",
    },
    {
      name: "Discord - Servidores",
      position: "Admin - Moderador",
      year: "2018 - Presente",
    },
  ];
          ...
          <div className="col-xl-12">
            <div className="title-area">
              <h2 className="sec-title mb-0" data-title="(2018 - 2025)">
                Experiencia de <span className="font2">Trabajo</span>
              </h2>
